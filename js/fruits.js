...
class Banana {
    constructor(x, y) {
            ...
            this.y = window.innerHeight + 100; //your actual screen height + 50 - banana start falling down from above (we are counting from the bottom - this is why it is not -50)
