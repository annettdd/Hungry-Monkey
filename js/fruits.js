...
class Banana {
    constructor(x, y) {
            ...
            this.y = window.innerHeight + 50; //your actual screen height + 50 - banana start falling down from above (we are counting fron the bottom - this is why it is not -50)
    ...
    render() {
        ...
        this.y = window.innerHeight + 50 - timePassed * this.speed; // new speed after refreshing the screen
